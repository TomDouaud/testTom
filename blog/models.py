...
class AlbumPhoto(models.Model):
    album = models.ForeignKey(AlbumOfTheMonth, related_name='photos', on_delete=models.CASCADE, help_text="Photos 'À la maison' pour l'album.")
    ...
    def __str__(self):
        return f"Photo {self.order} for {self.album.title}"
