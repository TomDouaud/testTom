...
from .models import AlbumOfTheMonth, AlbumTrack, AlbumPhoto, Playlist, Track, MovieImage, PasswordResetRequest
...
class AlbumOfTheMonthAdmin(admin.ModelAdmin):
    ...
    list_filter = ('month',)
    inlines = [AlbumTrackInline, AlbumPhotoInline]
...
class PasswordResetRequestAdmin(admin.ModelAdmin):
    ...
    mark_resolved.short_description = "Marquer les requêtes sélectionnées comme résolues"
